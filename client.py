...
def redrawWindow(win ,game, player):
    ...
    if not (game.connected()):
        ...
        text = font.render("Opponents", 1, (0,225, 255))
...
buttns = [Button("Rock", 50, 500, (0,0,0)), Button("Scissors", 250, 500, (255,0,0)), Button("Paper", 450, 500, (0,255,0))]
...
def main():
    ...
    network_con = Network()
    player = int(network_con.get_player())
